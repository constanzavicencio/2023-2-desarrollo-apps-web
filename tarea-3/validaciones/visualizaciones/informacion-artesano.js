 ...
 // Simular una base de datos o fuente de datos
 const artesanos = {
     '1': {
         nombre: 'Agustín',
    ...
    '5': {
     ...
     // Agregar información para otros artesanos
 };

 // Obtener la información del artesano según el 'id'
 const artesano = artesanos[id];

 // Rellenar la información en el HTML
 if (artesano) {
